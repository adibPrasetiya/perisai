    ...
    <template v-else>
      ...
      <div class="rec-card">
        ...
        <div v-if="currentStep === 0" class="rec-step-body">
          ...
          <template v-if="contextDetail && !contextLoading">
            ...
            <div v-if="contextDetail.contextType === 'PROCESS'" class="rec-form-group">
              <label class="rec-label">Kegiatan <span class="rec-opt">(opsional)</span></label>
              <div class="rec-select-wrap">
                <button
                  type="button"
                  class="rec-select-trigger"
        ...
        <div v-if="currentStep === 1" class="rec-step-body">
          ...
          <!-- Name -->
          <div class="rec-form-group">
            <label class="rec-label">Ancaman <span class="rec-req">*</span></label>
            <input
              v-model="form.name"
              type="text"
              class="rec-input"
          ...
          <div class="rec-form-group">
            <label class="rec-label">Kerentanan <span class="rec-opt">(opsional)</span></label>
...
async function loadContext(riskContextId: string) {
  ...
  try {
    ...
    if (res.data.data.contextType === 'ASSET') {
      ...
      const procRes = await KegiatanApi.search(unitKerjaId.value, { status: 'ACTIVE', limit: 100 })
