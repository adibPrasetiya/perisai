<template>
  ...
  <div v-if="visibleSections.length" class="menu-sections">
    <div v-for="section in visibleSections" :key="section.role" class="menu-section">
...
const visibleSections = computed(() => menuSections.filter((section) => hasRole(section.role)))
