...
const baseUrl = () => `/unit-kerja/${testUnitKerjaId}/kegiatan`;
...
const defaultBody = (suffix = Date.now()) => ({
  name: `Kegiatan Test ${suffix}`,
  code: `PB-T-${String(suffix)
    .toUpperCase()
    .replace(/[^A-Z0-9_-]/g, "-")}`,
});

// ─── POST /unit-kerja/:unitKerjaId/kegiatan ──────────────────────────────

describe("POST /unit-kerja/:unitKerjaId/kegiatan", () => {
  ...
  describe("Business Logic", () => {
    it("harus mengembalikan 404 jika unit kerja tidak ditemukan", async () => {
      const res = await adminAgent
        .post(`/unit-kerja/uk-tidak-ada/kegiatan`)
        .send(defaultBody());
  ...
  describe("Sukses", () => {
    it("harus mengembalikan 201 dan data Kegiatan yang dibuat", async () => {
...
// ─── GET /unit-kerja/:unitKerjaId/kegiatan ───────────────────────────────

describe("GET /unit-kerja/:unitKerjaId/kegiatan", () => {
  describe("Autentikasi", () => {
    it("harus mengembalikan 401 tanpa cookie autentikasi", async () => {
  ...
  describe("Business Logic", () => {
    it("harus mengembalikan 404 jika unit kerja tidak ditemukan", async () => {
      const res = await adminAgent.get(
        `/unit-kerja/uk-tidak-ada/kegiatan`,
      );
      expect(res.status).toBe(404);
    });
  });
...
// ─── PATCH /unit-kerja/:unitKerjaId/kegiatan/:id ────────────────────────

describe("PATCH /unit-kerja/:unitKerjaId/kegiatan/:id", () => {
  let pbId;
  ...
  describe("Business Logic", () => {
    it("harus mengembalikan 404 jika Kegiatan tidak ditemukan", async () => {
      const res = await adminAgent
    ...
    it("harus mengembalikan 403 jika Kegiatan sudah diarsipkan", async () => {
...
// ─── PATCH /unit-kerja/:unitKerjaId/kegiatan/:id/activate ───────────────

describe("PATCH /unit-kerja/:unitKerjaId/kegiatan/:id/activate", () => {
  let pbId;
  ...
  describe("Business Logic", () => {
    ...
    it("harus mengembalikan 400 jika Kegiatan sudah aktif", async () => {
    ...
    it("harus mengembalikan 400 jika Kegiatan sudah diarsipkan", async () => {
      await prismaClient.businessProcess.update({
        where: { id: pbId },
...
// ─── PATCH /unit-kerja/:unitKerjaId/kegiatan/:id/deactivate ─────────────

describe("PATCH /unit-kerja/:unitKerjaId/kegiatan/:id/deactivate", () => {
  let pbId;
  ...
  describe("Business Logic", () => {
    ...
    it("harus mengembalikan 400 jika Kegiatan sudah tidak aktif", async () => {
      await prismaClient.businessProcess.update({
        where: { id: pbId },
...
// ─── DELETE /unit-kerja/:unitKerjaId/kegiatan/:id (archive) ──────────────

describe("DELETE /unit-kerja/:unitKerjaId/kegiatan/:id", () => {
  let pbId;
  ...
  describe("Business Logic", () => {
    ...
    it("harus mengembalikan 400 jika Kegiatan masih ACTIVE", async () => {
      await prismaClient.businessProcess.update({
        where: { id: pbId },
        data: { status: "ACTIVE" },
      });
